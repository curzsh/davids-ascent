...
public class TitleScene extends Scene {
    ...
    private static final Color BG = new Color(0.03f, 0.02f, 0.06f, 1f);
    private static final Color TITLE_COLOR = new Color(1f, 0.85f, 0.3f, 1f);
    ...
    public void draw(TextureBatch batch) {
        ...
        for (int i = 0; i < starX.length; i++) {
            ...
            if (twinkle > 0.3f) {
                float s = 2f + twinkle;
                PlaceholderGraphics.drawRect(batch, starX[i], starY[i], s, s, STAR_COLOR);
            }
        }
        ...
        for (int i = 0; i < 12; i++) {
            ...
            PlaceholderGraphics.drawRect(batch, sx - 2, sy - 2, 4, 4, SUBTITLE_COLOR);
        }
        // Stone
        ...
        PlaceholderGraphics.drawRect(batch, stoneX - 4, stoneY - 4, 8, 8, Color.LIGHT_GRAY);
